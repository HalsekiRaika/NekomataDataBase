using BaseDataCollector.Generator;

namespace BaseDataCollector.Structure.Builder {
    ...
    public interface INeedThumbnail   { RefactorBuilder SetThumbnailData(BaseDataCollector.Structure.ThumbnailsData data); }
    ...
    public sealed class RefactorBuilder : INeedTitle, INeedDescription, INeedVideoId, INeedChannelId, 
        ...
        internal BaseDataCollector.Structure.ThumbnailsData Thumbnail { get; private set; }
        ...
        public RefactorBuilder SetThumbnailData(BaseDataCollector.Structure.ThumbnailsData data) {
            this.Thumbnail = data;
            return this;
        }

        public BaseDataCollector.Structure.RefactorScheme Build() {
            return new BaseDataCollector.Structure.RefactorScheme(this);
        }
    }
}