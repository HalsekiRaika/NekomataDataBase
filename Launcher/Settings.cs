...
namespace Launcher {
    public static class Settings {
        ...
        public static readonly string LibraryUrl = "https://github.com/ReiRokusanami0010/NekomataLibrary.git";
        ...
        public static bool   IsLibraryInstall     { get; set; } = false;

        public static string IgnoreDataArray { get; set; }

        // App Directories
        public static readonly string Controller = BuildDir + "YtDataCollector";
